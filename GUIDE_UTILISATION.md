...
| F04 | RENDER | codex + clips | `clip_00X.mp4` (Remotion) | CUSTOS |
...
### Les workflows GitHub Actions de la branche `dev`
...
| `F04 RENDER (dev)` | Rendu Remotion, **1 job par clip** | `clip` (clip-001..clip-005 ou `all`) | `clip-001` … `clip-005` |
...
## 8. RÉCUPÉRER LE PROJET DANS UN AUTRE ENVIRONNEMENT
