...
- [ ] **Preview en ligne** : activer Settings → Pages → Source "GitHub Actions", puis lancer le workflow "LACRIMAE Preview Pages" (déploiement manuel) — URL : `https://kioka8877-ux.github.io/LACRIMAE/`
