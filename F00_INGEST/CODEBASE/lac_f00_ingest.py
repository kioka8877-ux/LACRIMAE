"""
lac_f00_ingest.py — F00 INGEST : Porte d'entrée de la flotte LACRIMAE dev
=========================================================================
Accepte une vidéo longue (URL YouTube via yt-dlp ou fichier local).
Produit une vidéo source standardisée pour le pipeline dev.

Usage:
  python lac_f00_ingest.py --url "https://youtube.com/watch?v=XXX" --output /path/OUT/
  python lac_f00_ingest.py --file /path/IN/video.mp4 --output /path/OUT/

Entrée: URL YouTube OU fichier local
