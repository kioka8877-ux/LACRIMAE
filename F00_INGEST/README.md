...
`OUT/sequences.json` contient les frames de départ de la vidéo originale, leur position sur la timeline finale et leur durée. F00 copie la source dans `OUT` pour rendre le bundle autonome, mais ne produit pas de découpes MP4. Pour 10 secondes à 30 fps avec 7 frames par changement, le manifeste contient environ 43 à 44 séquences utilisées.
